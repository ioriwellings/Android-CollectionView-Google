...
public class CollectionView extends ListView {
    ...
    private void doFadeInAnimation() {
        ViewHelper.setAlpha( this, 0 );
        ViewPropertyAnimator.animate( this ).setDuration(250).alpha(1);
    }
        ...
        public boolean isEnabled( int row ) {
           if( mCallbacks != null ) {
         	  if( computeRowContent( row, mRowComputeResult ) ) {
         		  return mCallbacks.isViewEnabled( row, mRowComputeResult.groupId, mRowComputeResult.isHeader );
         	  }
           }
    ...
    private View getItemView(RowComputeResult rowInfo, int column, View view, ViewGroup parent) {
        ...
        if (indexInGroup >= rowInfo.group.mItemCount) {
            ...
            mCallbacks.onNewEmptyView( getContext(), view, rowInfo.groupId );
            return view;
        }
	...
	private LinearLayout.LayoutParams setupLayoutParams(View view) {
        ...
        if (view.getLayoutParams() instanceof LinearLayout.LayoutParams) {
            ...
            Log.d(TAG, "Unexpected class for collection view item's layout params: " +
    ...
    private View makeNewItemRow(RowComputeResult rowInfo) {
        ...
        if( mCallbacks != null ) {
      	  mCallbacks.onNewRowView( getContext(), ll, rowInfo.row, rowInfo.groupId );
        }
    ...
    public static class InventoryGroup implements Cloneable {
        ...
        private SparseIntArray mItemCustomDataIndices = new SparseIntArray();
