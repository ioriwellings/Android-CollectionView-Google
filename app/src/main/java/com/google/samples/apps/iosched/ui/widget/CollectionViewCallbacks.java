...
public interface CollectionViewCallbacks {
    ...
    void onNewEmptyView( Context context, View emptyView, int groupId );    
    void onNewRowView( Context context, LinearLayout rowView, int row, int groupId );
    
    boolean isViewEnabled( int position, int groupId, boolean isHeader );
}
